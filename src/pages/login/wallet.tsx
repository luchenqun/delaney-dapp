...
export const WalletConnect = () => {
  ...
  return (
    <>
      <div>
        <img
          className="w-screen absolute left-0 top-0"
          src={colorBg}
          alt="背景"
        />
        <div className="relative z-10 w-full flex justify-center pt-24">
          <div className="flex flex-wrap justify-center">
            ...
            <span className="w-full text-center font-normal text-xl">
              Delaney
            </span>
          </div>
        </div>
        ...
        <div className="flex justify-center w-screen absolute bottom-20 flex-wrap">
          ...
          <div
            ...
            className="flex justify-center items-center font-bold w-80 text-xl h-11 rounded-xl bg-[#46D69C] mt-4"
          >{`连接钱包`}</div>
        </div>
      </div>
    </>
